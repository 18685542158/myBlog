<template>
    <div class="box" @mousemove="moveProgress" @mouseup="leaveProgress" @mouseleave="leaveProgress">
        ...
        <div class="mainLeft">
            <div class="head">
                <video class="video" :src="urlsData[urlsData.length - 1]" @timeupdate="handleTimeUpdate" controls
                    autoplay @loadedmetadata="handleMetadataLoad" :currentTime="newCurrentTime">
                </video>
            </div>

            <div class="controls">
                <div class="progress" style="user-select: none;">
                    <div class="progressBox" @mousedown="downProgress" @mouseenter="openControl"
        ...
        <div class="mainRight" v-if="mvData.info.name">
            ...
            <div class="left">
                ...
                <!-- <span :class="isCol ? 'iconfont icon-shoucang1' : 'iconfont icon-shoucang'" @click="addCollection()">
                </span> -->
            </div>
        </div>
    </div>
