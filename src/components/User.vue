<template>
    <div class="box" :class="{ light: useLight.light.isLight}">
        <div class="header">
            ...
            <div class="userInfo">
                <h1>大山</h1>
                <h3>QQ:<span>1538518479</span></h3>
                <h3>Number:<span>18685542158</span></h3>
            </div>
        </div>
        <div class="userBody">
            <div class="content1">
                <h2>也许我们可以追求自己真正喜欢的事情，而不是整天为了满足物质需求而失去真实的自我。我们有能力成为自己想成为的人。</h2>
            </div>
            <div class="content2">
                <h2>毕业院校：湖南城市学院</h2>
                <h2>最高学历：这是个一本</h2>
            ...
            <div class="content3">
                <h2>我的爱好：偏艺术方面，例如音乐、吉他、绘画、摄影等等</h2>
            </div>
        </div>
    </div>
</template>
