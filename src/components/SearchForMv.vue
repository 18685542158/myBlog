    ...
    <div class="box">
        <ul>
            <li v-for="(item, index) in mvData" :key="index">
                <div class="item" @click="router.push({ name: 'MvDetail', params: { id: item.v_id || item.vid || item.videoid } })">
                    <div class="img">
                        <img :src="item.mv_pic_url || item.pic || item.cover_pic || item.picurl || item.cover" alt="">
                        <div class="cover">
                            <div class="playCount">
